...
export class UserComponent implements OnInit {
  ...
  addUser(): void {
    ...
    this.deleteStatus = false;
    this.updateStatus = false;
    let user: User = {"id":29,"email":"ashutoshkumarbth100@gmail.com","first_name":"Ashutosh","last_name":"Kumar","avatar":"https://reqres.in/img/faces/8-image.jpg"};
  ...
  updateUser(): void {
    ...
    let user:User = {"id":7,"email":"ajay123@gmail.com","first_name":"Ajay","last_name":"Kumar","avatar":""};
